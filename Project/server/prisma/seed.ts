...
async function main() {
  ...
  const configs = [
    ...
    { key: 'plotter_free_departments', value: '중앙동아리,자치기구', desc: '무료 인쇄 대상 소속 단위 (쉼표 구분)' },
    { key: 'plotter_free_purposes', value: '예산안 출력', desc: '무료 인쇄 대상 목적 (쉼표 구분)' },
    { key: 'plotter_departments_list', value: '총학생회,중앙동아리,자치기구,일반학회,단과대 학생회,기타', desc: '서비스 이용 가능 소속 단위 리스트 (쉼표 구분)' },
  ];
