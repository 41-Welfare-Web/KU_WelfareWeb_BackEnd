...
*   `PUT /api/items/instances/{instanceId}` (개별 실물 상태/비고/부위 상태 수정 - **Admin**, FR-34)
...
*   `GET /api/admin/holidays/calendar` (월별 휴무일 캘린더 조회 - **All**, 주말+등록휴무일 합산)
