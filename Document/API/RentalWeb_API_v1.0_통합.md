...
```json
{
  "departments": [
    ["총학생회"],
    ["중앙자치기구", "건국문화예술학생연합", "동아리연합회", "졸업준비위원회", "학생복지위원회"],
    ["문과대학", "국어국문학과", "영어영문학과", "중어중문학과", "철학과", "사학과", "지리학과", "미디어커뮤니케이션학과", "문화콘텐츠학과", "문과대학자유전공학부"],
    ["이과대학", "수학과", "화학과", "물리학과", "이과대학자유전공학부"],
    ["공과대학", "사회환경공학부", "기계항공공학부", "전기전자공학부", "화학공학부", "컴퓨터공학부", "산업경영공학부 산업공학과", "산업경영공학부 신산업융합학과", "생물공학과", "K뷰티산업융합학과"],
    ["건축대학"],
    ["경영대학", "경영학과", "기술경영학과"],
    ["사회과학대학", "정치외교학과", "경제학과", "행정학과", "국제무역학과", "응용통계학과", "융합인재학과", "글로벌비즈니스학과"],
    ["생명과학대학", "생명과학특성학과", "동물자원과학과", "..."],
    ["융합과학기술원", "미래에너지공학과", "스마트운행체공학과", "..."],
    ["부동산과학원", "부동산학과"],
...
```
* `departments`: 소속 목록 (이차원 배열). 각 배열의 `[0]`은 **소속 분류명**(단과대/기관명)이며, `[1:]`은 해당 분류에 속한 **하위 학과/부서** 목록입니다. 하위 항목이 없는 단일 소속은 분류명만 포함됩니다.
