...
```json
{
  "departments": [
    ["총학생회"],
    ["중앙자치기구", "대의원회", "동아리연합회", "졸업준비위원회", "학생복지위원회"],
    ["단과대", "공과대학", "문과대학", "경영대학", "예술디자인대학", "사회과학대학"],
    ["학과", "컴퓨터공학과", "전자공학과", "국어국문학과", "경영학과", "의상디자인학과", "융합인재학과"],
    ["중앙동아리", "A-Quick(축구)", "악동(밴드)", "소소(코딩)", "그림판(미술)"]
  ],
  "freePurposes": ["예산안 출력", "동아리 활동"],
  "prices": {
    "a0": 5000,
    "a1": 3000
  }
...
```
* `departments`: 소속 목록 (이차원 배열). 각 배열의 첫 번째 요소는 **대분류(유형)**이며, 그 뒤의 요소들은 해당 유형에 속한 **소분류(단위명)** 목록입니다.
